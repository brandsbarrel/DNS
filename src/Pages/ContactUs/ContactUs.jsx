...
export default function ContactUs() {
    ...
    return (
        <div className="contact-page">
            ...
            <div className="contact-cards">
                ...
                <div className="contact-card">
                    ...
                    <div className="contact-card-content">
                        <h2 className="contact-card-label">Looking for Consultation. Call us.</h2>
            ...
            {/* FOOTER IMAGE — outside form-section so no max-width/padding constraint */}
            <div className="contact-footer-img-wrap">
                <img src={footerImg} alt="SNG Maintenance" className="contact-footer-img" />
            </div>
